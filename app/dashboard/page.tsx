            ...
            {filteredProfiles.map((leader, idx) => (
              ...
              >
                <div>
                  ...
                  <div className="mt-5 grid grid-cols-4 gap-1 border-t border-b border-slate-800/60 py-3 text-center">
                    <div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 font-mono font-bold text-purple-400 text-xs sm:text-sm">
